...
const DangerTittle = ({ count, realLimitTop, warnExtremeBottomValue, warnIncorrectInputTopLimit, warnIncorrectInputBotLimit }: DangerTittleProps) => {
  return (
    <div className={s.title}>
      {!(count === realLimitTop) && !warnExtremeBottomValue && !warnIncorrectInputTopLimit && !warnIncorrectInputBotLimit && <span style={{ visibility: 'hidden' }} className={s.spanWarn}> ////// </span>}
